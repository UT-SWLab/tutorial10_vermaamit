...
public class DisplayColors {
    ...
    protected JPanel colorsPanel() {
        ...
        //need to instantiate the Original Color Panel and give it a dimension as we aren't calling createPanel()
        originalColorPanel = new OriginalColorPanel(0, (float) .5, (float) .5, hueSlider, saturationSlider, brightnessSlider);
        ...
        //need to instantiate the Complementary Color Panel and give it a dimension as we aren't calling createPanel()
        complementaryColorPanel = new ComplementaryColorPanel((float) .5, (float) .5, (float) .5, (OriginalColorPanel) originalColorPanel);
